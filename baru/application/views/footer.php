                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="instagram-title">
                            ...
                            <a class="btn-two" href="#">Sea turtles ( both green and hawksbill ) are a familiar sight in the gili island. <br>In order to be a responsible snorkeler, Be sure to respect the following rules when observing them. Do not attempt to touch or ride sea turtles<span class="flaticon-next"></span></a>
                        ...
                        <ul class="instagram-items clearfix">
                            <li>
                                <div class="img-holder">
                                    <img src="<?php echo base_url().'assets/'?>images/resources/instagram-1.jpg" alt="Awesome Image">
                                    
                                </div>
                            </li>
                            <li>
                                <div class="img-holder">
                                    <img src="<?php echo base_url().'assets/'?>images/resources/instagram-2.jpg" alt="Awesome Image">
                                    
                                </div>
                            </li>
                            <li>
                                <div class="img-holder">
                                    <img src="<?php echo base_url().'assets/'?>images/resources/instagram-3.jpg" alt="Awesome Image">
                                   
                                </div>
                            </li>
                            <li>
                                <div class="img-holder">
                                    <img src="<?php echo base_url().'assets/'?>images/resources/instagram-4.jpg" alt="Awesome Image">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="footer-bottom-content flex-box-two">
                            <div class="copyright-text">
                                <p>©2022 All Rights Reserved by <b>Gili Snorkeling.</b></p>
                            </div>
                            <div class="footer-social-links float-right">
                                <span>We are On:</span>
                                <ul class="sociallinks-style-one">
                                    <li class="wow slideInUp" data-wow-delay="0ms" data-wow-duration="1200ms">
                                        <a href="https://api.whatsapp.com/send?phone=6282340462426&amp;text=Hallo%20Gili%20Snorkeling"><i class="fa fa-whatsapp" aria-hidden="true"></i></a>
                                    </li>
