...
try {
    ...
    $mail->setFrom('info@domain.com', 'Message from Panagea');             // Email Address and Name FROM
    $mail->addAddress('info@domain.com', 'Jhon Doe');                           // Email Address and Name TO - Name is optional
    $mail->addReplyTo('noreply@domain.com', 'Panagea Newsletter');               // Email Address and Name NOREPLY
    $mail->isHTML(true);                                                       
    $mail->Subject = 'Thank you for join to Panagea Newsletter';                 // Email Subject     
    ...
    $mail->Body = "Thank you for join to Panagea Newsletter. You can unsubscribe at any time!";
