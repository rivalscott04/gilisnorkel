            ...
            <ul>
                <li class="slide-overlay" data-transition="fade">
                    ...
                    <div class="tp-caption text-color-light font-weight-normal"
                         ...
                         data-transform_in="y:[-50%];opacity:0;s:500;" style="z-index: 5;">Explore The Natural Beauty of Gili's with</div>
                    ...
                    <div class="tp-caption font-weight-extra-bold text-color-light negative-ls-2"
                         ...
                         data-lineheight="['15','15','15','45']" style="z-index: 5;">Gili Snorkeling</div>
            ...
            @foreach($paket as $item)
                <div class="col-md-3 col-sm-6 col-xs-12">
                    ...
                    <span class="thumb-info thumb-info-hide-wrapper-bg">
                        ...
                        <h4 class="font-weight-bold text-5 line-height-3 ls-0 mb-3">{{ $item->nama }}</h4>
                        ...
                        <span class="badge badge-primary badge-sm badge-pill px-2 py-1 mr-1">Water Activity</span> <a href="https://www.airbnb.co.id/experiences/3854605?location=Gili%20Trawangan%2C%20Gili%20Indah%2C%20North%20Lombok%20Regency%2C%20West%20Nusa%20Tenggara%2C%20Indonesia&currentTab=experience_tab&federatedSearchId=3bffbc1d-34fa-4022-8eec-fa797b6f23b0&searchId=8a33b3bd-9b7b-4f89-9284-554f1a32e45b&sectionId=8052fb27-6cf8-4a0f-a75e-32e7f02d1def&modal=REVIEWS"><b>327 reviews</b></a>
                            <br>
                             <!--span class="thumb-info-caption-text text-truncate" style="max-width: 320px; height: 100px; overflow:hidden">
                             {!! $item->deskripsi !!}
                             </span-->
                            
                            <div style="color:black"><b>The price start from :</b><br></div>
                            <div class="row">
                            <div class="col-7"><h2 class="font-weight-bold text-5 line-height-1 ls-0 mb-3"  style="color:red">Rp {{ number_format($item->paketHarga->first()?->harga??0) }}</h2></div>
                                <div class="col-5"> <span class="badge badge-danger badge-sm badge-pill px-2 py-1 mr-1">per person</span></div>
                            </div>
                            <!--a href="{{ route('frontend.booking.index',$item->id) }}" class="btn btn-modern btn-primary mt-3">Book Now</a-->
                            <a href="{{ route('frontend.paket-detail',$item->id) }}" class="btn btn-modern btn-primary mt-3">Book Now</a>
