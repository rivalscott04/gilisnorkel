        ...
        <div class="container">
            <div class="row mt-5">
                <div class="col-md-12 align-self-center p-static order-2 text-center">
                    <h1>Afternoon <strong>Private Tour</strong></h1>
                </div>
        ...
        <div class="row py-4">
            ...
            <div class="col-md-7 order-2">
                <div class="overflow-hidden">
                    <h2 class="text-color-dark font-weight-bold text-8 mb-0 pt-0 mt-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="300">Afternoon Private Tour</h2>
                </div>
                <div class="overflow-hidden mb-3">
                    <p class="font-weight-bold text-primary text-uppercase mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="500"><a href="#"><span class="badge badge-secondary badge-sm badge-pill text-uppercase px-2 py-1 mr-1">Afternoon Start 01:30 pm until 5:30 pm</span></a></p>	</div>
                <p align="justify" class="lead appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700">In the afternoon, you will meet with our crew at meeting point on Gili Trawangan and taken to the boat, ready for exploring the best snorkeling sites around Gili Meno and Gili Air.</p>
                <p align="justify" class="pb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">The crystal-clear waters are dotted with excellent snorkeling sites, most of which offer wonderful visibility throughout the year. Underneath the waves are tropical coral gardens teeming with biodiversity.
                    Jump into the calm and azure waters at Gili Meno and snorkel in one of the most unique areas, home to famed underwater statues.
                    Continue to Turtle Point where you have the chance to swim with friendly sea turtles.
                    The boat then cruises over to the reefs around Gili Air for more snorkeling among a myriad of colorful, tropical fish.
                    Once you're done on Gili air. During the return journey you will enjoy the amazing sunsets And tour end.
                </p>

                <div class="alert alert-info alert-sm"  data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">
                    <b>Price start from <strong class="font-weight-extra-bold"><b>IDR</b>  {{ number_format($afternoonPrivate?->paketHarga?->first()->harga??0)  }},00</strong> for {{ $afternoonPrivate?->paketHarga?->first()->keterangan??'' }} (All Price in Euro)</b><br>
                    <b>Prices Include</b> : Fins,Camera, Snorkels gear,Fresh water,Private boat, Private guide
                </div>
            ...
            <div class="col-md-5 order-md-2 mb-4 mb-lg-0 appear-animation" data-appear-animation="fadeInLeftShorter">
                <img src="{{asset("assets/frontend/img/team/team-7.jpg")}}" class="img-fluid" alt="">
            </div>
        </div>
    </div>
    <br><br>
