...
return [
    ...
    */
    ...
    'customClass' => [
        ...
        'title' => env('SWEET_ALERT_TITLE_CLASS','mb-0 p-0'),
        'closeButton' => env('SWEET_ALERT_CLOSE_BUTTON_CLASS'),
        'icon' => env('SWEET_ALERT_ICON_CLASS','w-20 h-20'),
        ...
        'confirmButton' => env('SWEET_ALERT_CONFIRM_BUTTON_CLASS','btn btn-primary mt-2 mb-3 w-100'),
        'cancelButton' => env('SWEET_ALERT_CANCEL_BUTTON_CLASS', 'btn btn-danger mt-2 mb-3'),
